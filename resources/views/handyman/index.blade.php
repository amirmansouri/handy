...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">handyman</div>
                    <div class="card-body">
                        <a href="{{ url('/handyman-create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($handyman_affiche as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/handyman-liste' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
